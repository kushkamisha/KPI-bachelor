...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton2->Text = L"Uniform search";
			...
			this->graph->Location = System::Drawing::Point(560, 40);
...
#pragma endregion
	private: System::Void MyForm_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		// axis Y
		graph->ChartAreas[0]->AxisY->ScaleView->Zoom(-40, 20);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	else
	{
		...
		{
			if (a == b)
				MessageBox::Show("X-range can't be equal to zero, enter different range.", "Error");
			else if (std::abs(a - b) > 1000)
				MessageBox::Show("X-range is too big, enter another range.", "Error");
			else if (std::abs(acc) > 0.1)
				MessageBox::Show("Accuracy must be no more than 0.1, enter another accuracy.", "Error");
			else
			{
				...
				if (radioButton1->Checked)
					result = GoldenSection::GoldenSectionSearch(ff, a, b, acc);
				if (radioButton2->Checked)
					result = Uniform::UniformSearch(ff, a, b, acc);
				if (radioButton3->Checked)
					result = Dichotomy::DichotomyMethod(ff, a, b, acc);
...
private: System::Void helpToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	String^ info = "This is a program to find extremum of input function on some range. You must just input function, \
range of finding extremums and accuracy and then click \"Go\" to get the answer.";
	MessageBox::Show(info, "Program information");
}
};
}